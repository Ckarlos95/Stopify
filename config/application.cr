...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Stopify web application."
  #
  #
  ...
  #
  # settings.secret_key_base= RNQNDLelKvjhflszmdN2QxQoFW7Q-STvo3zh8BPu61I
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("stopify.log", "w"))
  #
  #
end
